...
alias r="pacman -Rns"
alias i="pacman -S"
alias rz="yay -Qetq | fzf -m --preview 'yay -Qi {1}' > /tmp/pd; xargs -ra /tmp/pd yay -Rns"
alias iz="yay -Slq | fzf -m --preview 'yay -Si {1}' > /tmp/pi; xargs -ra /tmp/pi yay -S"
alias py="python"
alias re="sudo \$(fc -ln -1)"
alias s="sudo"
alias to="touch"
alias u="sudo reflector -p https -f16 -l8 --score 4 --sort rate --save /etc/pacman.d/mirrorlist && cat /etc/pacman.d/mirrorlist && echo && yay"
